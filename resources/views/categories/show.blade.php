  ...
  <div class="row col-sm-9 border">
    ...
    {{-- @foreach ($cats as $cat) --}}
      <div class="col-sm-12">
        ...
        <div class="col-sm-5">
          <img src="{{ asset('images/categories/' . $cat->image) ? : asset('images.Noimage.jpg')}}" width="100%" height="250px" alt="{{$cat->title}}">
        </div>
    </div>
    ...
    @if(count($cat->products) > 0)
      ...
      @foreach($cat->products as $product)
        <div class="col-sm-2">
            ...
            <img class="text-center" src="{{ asset('images/products/'.$product->image) }}" width="auto" height="120x" alt="{{$product->title}}" title"{{$product->title}}">
