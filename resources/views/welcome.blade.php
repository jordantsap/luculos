...
<body>
    <div id="main-container" class="w-90 vh-100 bg-white">

        <div id="top-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm m-1 ml-5">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-envelope" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2zm13 2.383l-4.758 2.855L15 11.114v-5.73zm-.034 6.878L9.271 8.82 8 9.583 6.728 8.82l-5.694 3.44A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.739zM1 11.114l4.758-2.876L1 5.383v5.73z" />
                        </svg>
                        <span>
                            <a href="mailto:info@luculos.com">info@luculos.com</a>
                        </span>
                    </div>
                    ...
                    <nav class="mx-auto navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#">Premium Quality</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#">Bio Products</a>
                                </li>
                                <li class="nav-item">
        ...
        <div id="home-content">
            <div class="container w-100 h-auto">
                ...
                <a href="">
                    <img src="{{ asset('images/greekfood.jpg')}}" width="100%" height="300px" alt="Discover the luculos greek foods">
                </a>
            </div>
        </div>
            ...
            <div class="container clearfix">
                <ul class="et-social-icons">
                    ...
                    <li class="et-social-icon et-social-facebook">
                        <a href="https://www.facebook.com/luculosfood/" class="icon">
                            <span>Facebook</span>
                        </a>
                    </li>
